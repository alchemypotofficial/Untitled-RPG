...
void Draw_Actor(GameActor* actor)
{
    if(actor != NULL)
    {
        if(actor->party_slot == 0 && actor->active_member == true)
        {
            ...
            if(actor->level > 9){Draw_Number(actor->level, 11, 3);}
            else{Draw_Number(actor->level, 10, 3);}
        ...
        else if(actor->party_slot == 1 && actor->active_member == true)
        {
            ...
            if(actor->level > 9){Draw_Number(actor->level, 11, 6);}
            else{Draw_Number(actor->level, 10, 6);}
        }
        else if(actor->party_slot == 2 && actor->active_member == true)
        {
            ...
            if(actor->level > 9){Draw_Number(actor->level, 11, 9);}
            else{Draw_Number(actor->level, 10, 9);}
        }
        else if(actor->party_slot == 3 && actor->active_member == true)
        {
            ...
            if(actor->level > 9){Draw_Number(actor->level, 11, 12);}
            else{Draw_Number(actor->level, 10, 12);}
        }
    }
}
