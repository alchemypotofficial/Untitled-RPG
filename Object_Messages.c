...
const GameMessage message_test = {bank10, Message_Test, 6};

const GameMessage message_intro_1 = {bank10, Message_Intro_1PLN0, 2};
const GameMessage message_intro_2 = {bank10, Message_Intro_2PLN0, 4};
const GameMessage message_intro_3 = {bank10, Message_Intro_3PLN0, 6};
const GameMessage message_intro_4 = {bank10, Message_Intro_4PLN0, 2};
const GameMessage message_intro_5 = {bank10, Message_Intro_5PLN0, 8};
const GameMessage message_intro_6 = {bank10, Message_Intro_6PLN0, 6};
const GameMessage message_intro_7 = {bank10, Message_Intro_7, 4};
